...
public final class ASelectApplyTemplatesOptions extends PApplyTemplatesOptions
{
    private TSelect _select_;
    private TEqual _equal_;
    private PText _text_;

    public ASelectApplyTemplatesOptions()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASelectApplyTemplatesOptions(
    ...
    {
        ((Analysis) sw).caseASelectApplyTemplatesOptions(this);
    }
