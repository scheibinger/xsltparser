...
public final class AAttributeElement extends PAttributeElement
{
    private TXsltTag _xsltTag_;
    private TAttribute _open_;
    ...
    private TAttribute _close_;
    private TCloseTag _closeXslt_;

    public AAttributeElement()
    {
        // Constructor
    }
    ...
    public AAttributeElement(
        ...
        @SuppressWarnings("hiding") TAttribute _open_,
        ...
        @SuppressWarnings("hiding") TAttribute _close_,
    ...
    {
        ((Analysis) sw).caseAAttributeElement(this);
    }
    ...
    public TAttribute getOpen()
    {
        return this._open_;
    }

    public void setOpen(TAttribute node)
    {
        if(this._open_ != null)
        {
    ...
    public TAttribute getClose()
    {
        return this._close_;
    }

    public void setClose(TAttribute node)
    {
