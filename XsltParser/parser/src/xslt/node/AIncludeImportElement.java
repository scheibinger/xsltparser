...
public final class AIncludeImportElement extends PImportElement
{
    ...
    public Object clone()
    {
        return new AIncludeImportElement(
    ...
    {
        ((Analysis) sw).caseAIncludeImportElement(this);
    }
