...
public final class AParameterApplyTemplatesParameters extends PApplyTemplatesParameters
{
    private PParameter _parameter_;

    public AParameterApplyTemplatesParameters()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParameterApplyTemplatesParameters(
            cloneNode(this._parameter_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAParameterApplyTemplatesParameters(this);
    }
